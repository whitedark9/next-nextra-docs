...
const config: DocsThemeConfig = {
  project: {
    link: "https://github.com/shuding/nextra", // TODO: rename this
  },
  // Edit this page
  // Question? Give us feedback
  // will be affected by this link
  docsRepositoryBase: "https://github.com/shuding/nextra/tree/main/docs", // TODO: rename this
  useNextSeoProps() {
    const { asPath } = useRouter();
    if (asPath !== "/") {
      return {
        titleTemplate: "%s – Nextra", // TODO: rename this
      };
    }
  },
  logo,
  // TODO: use your site information
